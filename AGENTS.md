...
6. The calibration state machine is driven by the 1kHz mouse thread; the AI thread only responds to the three atomics `g_calib_collect`/`g_calib_request`/`g_calib_done`.
