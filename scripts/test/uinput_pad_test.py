...
#    sudo python3 scripts/test/uinput_pad_test.py \
...
def main():
    ...
    print("== 准备: 虚拟手柄 + 启动 aimbot (-M pad --pad-dump -P padtest)")
    pad = VPad()
    ...
    proc = subprocess.Popen(
        [args.aimbot, "-M", "pad", "--pad-dump", "-P", "padtest",
